...
public class CatalegPelisMVC {
    ...
    private void run() {
        ...
        do {
            ...
            switch (opcio) {
                ...
                case 9:
                    System.out.println("Has seleccionat: Llistar pel�l�cules ordenadas por nombre");
    ...
    private void anyadirItemsMenu(Menu menuConsola) {
        menuConsola.afegirOpcio("Afegir Pel�l�cula");
        menuConsola.afegirOpcio("Buscar pel�l�cula per id");
        menuConsola.afegirOpcio("Buscar pel�l�cula con segundas parte");
        menuConsola.afegirOpcio("Borrar pel�l�cula");
        menuConsola.afegirOpcio("Llistar pel�l�cules");
        menuConsola.afegirOpcio("Borrar pel�l�cula por nombre");
        menuConsola.afegirOpcio("Filtrar por Genero");
        menuConsola.afegirOpcio("Afegir Pel�l�cula");
        menuConsola.afegirOpcio("Llistar pel�l�cules ordenades");
